...
const PageWrapper = ({ children, header, title }: PageWrapperProps) => {
  return (
    <div className="fixed inset-0 flex flex-col items-center">
      ...
      <div className="flex h-full w-full justify-center overflow-y-auto bg-gray-100 p-4 shadow-md">
        <div className="flex h-full w-full max-w-4xl flex-col gap-8 overflow-y-auto py-8">
